...
class TickerBase:
    """A base class for Yahoo! Finance APIs.
    ...
    def history(
        ...
        Returns:
            df: Stock price history for a specified `period` and `interval`
        """
        ...
        if isinstance(repair, str) and repair == "silent":
            utils.log_once(
                logging.WARNING,
                "yfinance: Ticker.history(repair='silent') value is deprecated and will be removed in future version. Repair now silent by default, use logging module to increase verbosity.",
            )
            repair = True
        if repair:
    ...
    def _reconstruct_intervals_batch(self, df, interval, prepost, tag=-1):
        ...
        price_cols = [
            c for c in ["Open", "High", "Low", "Close", "Adj Close"] if c in df
        ]
        ...
        for g in dts_groups:
            ...
            if interval == "1d":
                ...
                if f_tag.any():
                    ...
                    div_adjusts = div_adjusts.fillna(method="bfill").fillna(
                        method="ffill"
                    )
                    ...
                    if f_close_bad.any():
                        df_new.loc[f_close_bad, "Adj Close"] = (
                            df_new["Close"][f_close_bad] * div_adjusts[f_close_bad]
                        )
    ...
    def _fix_zeroes(self, df, interval, tz_exchange, prepost):
        ...
        price_cols = [
            c for c in ["Open", "High", "Low", "Close", "Adj Close"] if c in df2.columns
        ]
    ...
    def get_recommendations(self, proxy: str = None, as_dict: bool = False):
        """
        Parameters:
            proxy:
                Proxy server URL scheme. Default is None.
            as_dict:
                Output as dict. Defaults to False.

        Returns:
            data: Analyst recommendations with ratings and price targets.
        """
    ...
    def get_major_holders(self, proxy=None, as_dict=False):
        ...
        Returns:
            data: Major holders data with percentage of holdings.
        """
    ...
    def get_institutional_holders(self, proxy=None, as_dict=False):
        ...
        Returns:
            data: Institutional holders data with share details and ownership.
        """
        self._holders.proxy = proxy
    ...
    def get_mutualfund_holders(self, proxy=None, as_dict=False):
        ...
        Returns:
            data: Mutual fund holders data with share details and ownership.
        """
        self._holders.proxy = proxy
    ...
    def get_info(self, proxy=None) -> dict:
        ...
        Returns:
            data: General information including company description, sector, and more.
        """
        self._quote.proxy = proxy
    ...
    @property
    def basic_info(self):
        """A subset of general information data."""
        warnings.warn(
    ...
    def get_sustainability(self, proxy=None, as_dict=False):
        ...
        Returns:
            data: Sustainability data including environmental, social, and governance scores.
        """
        self._quote.proxy = proxy
    ...
    def get_recommendations_summary(self, proxy=None, as_dict=False):
        ...
        Returns:
            data: A data structure containing a summary of recommendations, such as buy, hold, sell ratings.
        """
        self._quote.proxy = proxy
        data = self._quote.recommendations
        if as_dict:
    ...
    def get_analyst_price_target(self, proxy=None, as_dict=False):
        ...
        Returns:
            data: Analysts' price targets with details such as mean, high, and low targets.
        """
    ...
    def get_rev_forecast(self, proxy=None, as_dict=False):
        ...
        Returns:
            data: Revenue forecasts with estimates and historical data.
        """
        self._analysis.proxy = proxy
    ...
    def get_earnings(
        self, proxy: str = None, as_dict: bool = False, freq: str = "yearly"
    ):
        """
        Parameters:
            as_dict:
        ...
        Returns:
            data: Earnings information in the form of a `pandas.DataFrame` or dictionary
        """
    ...
    def get_incomestmt(self, proxy=None, as_dict=False, pretty=False, freq="yearly"):
        ...
        Args:
            ...
            as_dict:
                Output as dict. Defaults to False.
            freq:
                _description_. Defaults to "yearly".
    ...
    def get_balance_sheet(
        ...
        Returns:
            data: Balance sheeet information in the form of a `pandas.DataFrame` or dictionary
        """
        self._fundamentals.proxy = proxy
    ...
    def get_cash_flow(
        ...
        Returns:
            data: Cash flow data in the form of a `pandas.DataFrame` or dictionary
        """
        self._fundamentals.proxy = proxy
    ...
    def get_cashflow(self, proxy=None, as_dict=False, pretty=False, freq="yearly"):
        """Parameters:
           ...
           as_dict:
                Output as dict. Defaults to False.
            pretty (bool, optional): _description_. Defaults to False.
            freq (str, optional): _description_. Defaults to "yearly".
    ...
    def get_earnings_dates(
        self, limit: int = 12, proxy: str = None
    ) -> Optional[pd.Series]:
        """
        ...
        Parameters:
            limit: int
                max amount of upcoming and recent earnings dates to return.
                Default value 12 should return next 4 quarters and last 8 quarters.
                Increase if more history is needed.

            proxy: str
                requests proxy to use.

        Returns:
            dates: A Series of earnings dates.
        """
