...
def download(
    ...
    """Download stock-level information for a list of ticker symbols.
    ...
    Returns:
        data: Stock price history for a ticker or list of tickers
    """
    ...
    try:
        data = _pd.concat(
            shared._DFS.values(), axis=1, sort=True, keys=shared._DFS.keys()
        )
    except Exception:
        _realign_dfs()
        data = _pd.concat(
